window.addEventListener('DOMContentLoaded', async function()
{
	...
	const cubes = [
		{ center: p(-1, -1, -2),	faces: [ Colour.Magenta, Colour.Red, Colour.Blue, Colour.White, Colour.Yellow, Colour.Green ] },
		{ center: p(-1, 0, -2),		faces: [ Colour.Red, Colour.Green, Colour.Yellow, Colour.Blue, Colour.Magenta, Colour.White ] },
		{ center: p(0, 0, -2),		faces: [ Colour.Magenta, Colour.White, Colour.Blue, Colour.Red, Colour.Green, Colour.Yellow ] },
		{ center: p(-1, -1, -1),	faces: [ Colour.Red, Colour.Green, Colour.Blue, Colour.Magenta, Colour.Yellow, Colour.White ] },
		{ center: p(0, -1, -1),		faces: [ Colour.White, Colour.Magenta, Colour.Yellow, Colour.Red, Colour.Blue, Colour.Green ] },
		{ center: p(0, 0, -1),		faces: [ Colour.Green, Colour.White, Colour.Blue, Colour.Yellow, Colour.Red, Colour.Magenta ] },
		{ center: p(0, 1, -1),		faces: [ Colour.Blue, Colour.Red, Colour.White, Colour.Magenta, Colour.Yellow, Colour.Green ] },
		{ center: p(1, 1, -1),		faces: [ Colour.Red, Colour.White, Colour.Green, Colour.Yellow, Colour.Blue, Colour.Magenta ] },
		{ center: p(-2, 0, 0),		faces: [ Colour.Magenta, Colour.White, Colour.Red, Colour.Yellow, Colour.Blue, Colour.Green ] },
		{ center: p(-2, 1, 0),		faces: [ Colour.Magenta, Colour.Blue, Colour.Green, Colour.Red, Colour.White, Colour.Yellow ] },
		{ center: p(-1, -1, 0),		faces: [ Colour.Magenta, Colour.Green, Colour.Blue, Colour.White, Colour.Red, Colour.Yellow ] },
		{ center: p(-1, 0, 0),		faces: [ Colour.Blue, Colour.Magenta, Colour.Green, Colour.Red, Colour.White, Colour.Yellow ] },
		{ center: p(0, -2, 0),		faces: [ Colour.Yellow, Colour.Green, Colour.Red, Colour.White, Colour.Magenta, Colour.Blue ] },
		{ center: p(0, 1, 0),		faces: [ Colour.White, Colour.Blue, Colour.Yellow, Colour.Red, Colour.Magenta, Colour.Green ] },
		{ center: p(0, 2, 0),		faces: [ Colour.White, Colour.Green, Colour.Blue, Colour.Magenta, Colour.Red, Colour.Yellow ] },
		{ center: p(1, -2, 0),		faces: [ Colour.Blue, Colour.Red, Colour.Yellow, Colour.Green, Colour.Magenta, Colour.White ] },
		{ center: p(1, -1, 0),		faces: [ Colour.Magenta, Colour.White, Colour.Yellow, Colour.Blue, Colour.Green, Colour.Red ] },
		{ center: p(1, 0, 0),		faces: [ Colour.Red, Colour.Blue, Colour.Green, Colour.White, Colour.Yellow, Colour.Magenta ] },
		{ center: p(1, 1, 0),		faces: [ Colour.Magenta, Colour.Green, Colour.White, Colour.Red, Colour.Blue, Colour.Yellow ] },
		{ center: p(2, 0, 0),		faces: [ Colour.Red, Colour.White, Colour.Magenta, Colour.Yellow, Colour.Blue, Colour.Green ] },
		{ center: p(2, 1, 0),		faces: [ Colour.Green, Colour.White, Colour.Blue, Colour.Magenta, Colour.Yellow, Colour.Red ] },
		{ center: p(-1, 0, 1),		faces: [ Colour.Yellow, Colour.White, Colour.Red, Colour.Magenta, Colour.Blue, Colour.Green ] },
		{ center: p(-1, 1, 1),		faces: [ Colour.Magenta, Colour.Yellow, Colour.Blue, Colour.Green, Colour.Red, Colour.White ] },
		{ center: p(-1, 2, 1),		faces: [ Colour.Green, Colour.Yellow, Colour.White, Colour.Blue, Colour.Magenta, Colour.Red ] },
		{ center: p(0, -2, 1),		faces: [ Colour.White, Colour.Green, Colour.Blue, Colour.Red, Colour.Magenta, Colour.Yellow ] },
		{ center: p(0, -1, 1),		faces: [ Colour.White, Colour.Blue, Colour.Red, Colour.Yellow, Colour.Green, Colour.Magenta ] },
		{ center: p(0, 2, 1),		faces: [ Colour.Green, Colour.Blue, Colour.White, Colour.Red, Colour.Magenta, Colour.Yellow ] },
		{ center: p(1, -1, 1),		faces: [ Colour.Green, Colour.White, Colour.Blue, Colour.Magenta, Colour.Red, Colour.Yellow ] },
		{ center: p(0, -1, 2),		faces: [ Colour.Red, Colour.Yellow, Colour.White, Colour.Blue, Colour.Magenta, Colour.Green ] },
		{ center: p(0, 0, 2),		faces: [ Colour.Yellow, Colour.Blue, Colour.Green, Colour.White, Colour.Red, Colour.Magenta ] }
	];
